...
**Model type:** Exploratory leadership model<br>
...
This is an **exploratory leadership model**.

It represents thinking in development and is **not intended to be cited or used as a stable reference**.
The model is published to make a line of reasoning visible, not to establish a finalized position.
